#!/usr/bin/env python3
"""
Валидатор 1.5: Заполнение даты разработки
Источник ТЗ: ТЗ_Валидация_КПСЦ_v2_упрощенная.md, Раздел 1, Проверка 1.5
"""
import os
import json
import argparse
...
def extract_relevant_data(data: dict) -> dict:
    ...
    return {
        "date_developed": data["fields"].get("date_developed", "")
    }
