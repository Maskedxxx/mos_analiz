#!/usr/bin/env python3
"""
Валидатор 1.7: Заполнение поля "Кто составил" (ФИО)
Источник ТЗ: ТЗ_Валидация_КПСЦ_v2_упрощенная.md, Раздел 1, Проверка 1.7
"""
import os
import json
import argparse
...
def extract_relevant_data(data: dict) -> dict:
    ...
    return {
        "compiled_by": data["fields"].get("compiled_by", "")
    }
