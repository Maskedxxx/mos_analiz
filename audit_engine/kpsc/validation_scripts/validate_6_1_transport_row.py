#!/usr/bin/env python3
"""
Валидатор 6.1: Наличие строки "Перемещения" в блоке "Расчет ВПП"
Источник ТЗ: ТЗ_Валидация_КПСЦ_v2_упрощенная.md, Раздел 6, Проверка 6.1
"""
import os
import json
import argparse
...
def extract_relevant_data(data: dict) -> dict:
    ...
    return {
        "file_exists": True,
        "has_transport_row": has_transport_row,
        "transport_row_index": transport_row_num
    }
