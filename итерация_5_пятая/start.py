...
# -*- coding: utf-8 -*-
"""
Стартовый скрипт для LLM-аудита документа "Приказ о создании ИЦ" (электронный вид).
...
# Шаблон по умолчанию (электронный вид)
DEFAULT_TEMPLATE = "prikaz_ic_el_template.docx"
