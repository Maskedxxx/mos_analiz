#!/usr/bin/env python3
"""
Валидатор 7.5: Наличие и заполнение листа "ПА-1"
Источник ТЗ: ТЗ_Валидация_КПСЦ_v2_упрощенная.md, Раздел 7, Проверка 7.5
"""
import os
import json
import argparse
...
def load_data(parser_outputs_dir: Path) -> dict:
    ...
    files_exist = {
        "pa1_table_v1.json": pa1_table_file.exists(),
        "pa1_chart_v3.json": pa1_chart_file.exists()
    }
