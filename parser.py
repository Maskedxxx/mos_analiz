...
def parse_excel_to_json(excel_path: Path, sheet_name: Optional[str] = None) -> Dict[str, object]:
    """
    Парсит Excel-файл с драйверами производительности в структурированный JSON.
    ...
    sheet_name : Optional[str]
        Имя листа для парсинга (по умолчанию первый видимый)

    Returns
    -------
    Dict[str, object]
        Словарь с метаинформацией и секциями
    """
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    result = parse_excel_to_json(args.xlsx, args.sheet)
