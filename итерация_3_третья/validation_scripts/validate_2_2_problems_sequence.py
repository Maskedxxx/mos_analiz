#!/usr/bin/env python3
"""
Валидатор 2.2: Последовательность номеров проблем (пропуски в нумерации)
Источник ТЗ: ТЗ_Валидация_КПСЦ_v2_упрощенная.md, Раздел 2, Проверка 2.2
"""
import os
import json
import argparse
...
def extract_relevant_data(data: dict) -> dict:
    ...
    return {
        ...
        "has_missing": len(missing_numbers) > 0
    }
